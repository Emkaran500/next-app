...
export default function SearchSuggestion() {
    ...
    {
        var category = navbar[0].items[Math.floor(Math.random()*navbar[0].items.length)];
      ...
      <>
        <CommandGroup heading="Categories">
          {categories.map((category) => (
            <CommandItem key={category.id} value={category.title} onSelect={() => {}}  style={{ cursor: 'pointer' }}>
